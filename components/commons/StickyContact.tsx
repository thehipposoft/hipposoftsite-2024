...
const StickyContact = () => {
    ...
    return (
        <Link href={'/contact'} className={`${currentPath === '/contact' ? 'hidden' : ''} fixed z-40 lg:w-[4vw] md:w-[7vw] w-[15vw] cursor-pointer bg-black/20 duration-500 hover:bg-black/50 hover:scale-105 rounded-full  bottom-7 md:right-8 right-7 p-2`}>

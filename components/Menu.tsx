...
const Menu = () => {
    ...
    return (
        <div ref={container} className=''>
            ...
            <div className={`menu translate-x-[100%] opacity-100 fixed top-0 right-0 flex flex-col justify-center items-center md:items-start bg-brand-purple z-40 md:px-32 h-screen w-screen py-4`} >

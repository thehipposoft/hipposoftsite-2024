...
export default function PerriPage() {
    ...
    const DATA = {
        logo: '/assets/images/logofolio/perri-logo.webp',
        backgroundOne: "/assets/images/logofolio/perri/perri-1.webp",
        secondSectionCustom: true,
        backgroundTwo: "/assets/images/logofolio/perri/perri-2.webp",
        itemImage: "/assets/images/logofolio/perri/perri-3.webp",
        contain: true,
        colorPrimary: "#0043AC",
        colorSecondary: ["#F78A1D", "#00AFC8", "#00B97D"],
    ...
    return (
        <div ref={container} className='flex flex-col'>
            ...
            <div className='h-[150vh] flex justify-center sticky top-0 pt-[35vh]'>
                <Image sizes='100vw' fill src="/assets/images/logofolio/perri/perri-1.webp" alt='Background' className='-z-10' />
                <Image src='/assets/images/logofolio/perri-logo.webp' alt='PERRI Logo' sizes='375px' width={375} height={200} className='object-contain logo max-h-[250px]' />
            </div>
            <div className='h-screen sticky top-0 flex items-center justify-center'>
                <Image sizes='100vw' src="/assets/images/logofolio/perri/perri-2.webp" fill className='object-cover' alt='PERRI image 2' />
                <div className='flex md:flex-row flex-col relative z-20'>
            ...
            <div className='h-screen flex flex-col lg:flex-row relative'>
                <div className='bg-white lg:w-1/2 relative h-screen'>
                    <Image sizes='50vw' src="/assets/images/logofolio/perri/perri-3.webp" fill className='object-contain' alt='Object image' />
                </div>
                <div style={{ gridTemplateColumns: `repeat(3, minmax(0, 1fr))` }} className='lg:w-1/2 grid grid-rows-2 h-screen'>
                    <div style={{ backgroundColor: "#0043AC" }} className='col-span-full flex justify-end items-end p-4 w-full'>
                        #0043AC
                    </div>
                    {
                        ["#F78A1D", "#00AFC8", "#00B97D"].map((val, index) => (
            ...
            <div className='flex flex-col relative'>
                <div className='flex lg:flex-row flex-col h-screen sticky top-0'>
                    <div style={{ backgroundColor: "#FFFFFF" }} className='lg:w-1/2 flex justify-center items-center relative h-screen lg:h-auto'>
                        <Image sizes='50vw' src="/assets/images/logofolio/perri/perri-4.webp" alt='Legend background Image' fill className='object-cover' />
                    </div>
                    <div className='lg:w-1/2 relative' style={{ backgroundColor: "#FFFFFF" }}>
                        <Image sizes='50vw' src="/assets/images/logofolio/perri/perri-7.webp" fill className='object-contain legend-image' alt='Background three' />
                    </div>
                </div>
                <div style={{ backgroundColor: "#FFFFFF" }} className='h-[50vh]' />
            </div>
            <div className='flex flex-col relative bg-white'>
                <div className='flex lg:flex-row flex-col h-screen sticky top-0'>
                    <div style={{ backgroundColor: "#FFFFFF" }} className='lg:w-3/5 flex justify-center items-center relative h-screen lg:h-auto'>
                        <Image sizes='60vw' src="/assets/images/logofolio/perri/perri-5.webp" alt='Legend background Image' fill className='object-contain' />
                    </div>
                    <div className='lg:w-fit relative flex flex-col justify-center lg:items-end' style={{ backgroundColor: "#FFFFFF" }}>
                        <Image src="/assets/images/logofolio/perri/perri-6.webp" width={450} height={200} className='object-contain' alt='Background three' />
                        <div className='uppercase flex flex-col items-center lg:items-start py-6 lg:py-0 text-black md:gap-0 gap-2 lg:pt-20'>
                            <h3 className='light uppercase'>perri</h3>
                            <h3 className='light uppercase'>salta - argentina</h3>
                            <h3 className='light uppercase'>january - 2026</h3>
                        </div>
                    </div>
                </div>
            </div>

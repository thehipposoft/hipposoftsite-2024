            ...
            <div className='lg:w-[1200px] w-[85vw] flex flex-col mx-auto relative z-10 gap-8 my-8 md:my-0'>
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-14 lg:gap-0'>
                    <div className='flex flex-col gap-10'>
                        <h2 className='md:text-7xl text-5xl text-black'>Let´s take the<br/> next step!</h2>
                        <div className='flex flex-col gap-12 mt-8'>
                            <Link href={'mailto:hello@thehipposoft.com'} className='flex gap-4 items-center w-fit'>
                            ...
                            <Link href={'tel:61 414 286 242'} className='flex gap-4 items-center w-fit'>
